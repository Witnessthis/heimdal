...
// pointer listeners. Nothing here needs a named import from it, but the
// module must still be loaded for those listeners to exist at all.
import './feed/gestures.js';
import { closeSwipe, openSwipeCard } from './feed/swipe-state.js';
import {
